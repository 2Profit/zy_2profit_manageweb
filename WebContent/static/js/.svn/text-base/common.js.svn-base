...
(function (window, undefined) {
    ...
    jc.mask = {
        ...
        init: function () {
            ...
            this.oMask.style.cssText = 'display:none;position:fixed;_position:absolute;top:0;left:0;width:100%;height:100%;background :#545454;z-index:9999;filter:alpha(opacity=50);opacity:0.5';
        },
